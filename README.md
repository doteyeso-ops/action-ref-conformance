# action-ref-v1 conformance — Vibes-Coded
...
**Anyone can recompute these without running Vibes-Coded's service** — you need only
...
byte-for-byte — all 13 of their vectors pass here, and ours are shape-compatible with
